...
- [Evidence-led improvement loop](issues/07-engineer-evidence-led-improvement-loop.md) — an evidence-backed problem inventory comes before solutions; I-01 tackles large-plan comprehension beyond Mermaid, and each later issue receives its own minimum real evidence, correction, and regression proof before another prerelease.
