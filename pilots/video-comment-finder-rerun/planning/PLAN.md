...
- [P-001](decisions/P-001-define-finder-contract.md): Drew supplies and maintains a saved pool of promising AI channel names; the skill discovers relevant videos within that pool, finds linked questions, and stops before answering.
...
- Next: Decide what evidence the skill requires before treating Drew as qualified to answer a question.
